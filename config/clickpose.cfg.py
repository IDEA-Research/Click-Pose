...
human_feedback = False # True for Interactive Training; False for Model_Only Training

feedback_loop_NOC_test=False # True for NoC Test

feedback_inference=False  # True for Regular Test
...
num_group_refine = 20
cls_no_bias = False
num_body_points = 17 # for coco, humanart, ochuman
