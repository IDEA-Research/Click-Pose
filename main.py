...
def main(args):
    ...
    if args.dataset_file=="coco":
        args.coco_path = os.environ.get("CLICKPOSE_COCO_PATH")
    elif args.dataset_file=="crowdpose":
        args.coco_path = os.environ.get("CLICKPOSE_CrowdPose_PATH")
    elif args.dataset_file=="humanart":
        args.coco_path = os.environ.get("CLICKPOSE_HumanArt_PATH")
    elif args.dataset_file=="ochuman":
        args.coco_path = os.environ.get("CLICKPOSE_OCHuman_PATH")
